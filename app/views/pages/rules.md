...
### Section 4. Compter les PV et la Res Corp
...
Cette appréciation évidemment subjective est faite par le MJ, avec le maximum d’équité possible et en prenant en compte les spécificités de chaque personnage et de chaque situation.
...
Concernant le chiffre à atteindre en faisant un jet : L’effet des compétences fonctionne classiquement par seuil de réussite de 5.
...
## Chapitre 3. Les regles du combat au sol
...
De même, un ennemi qui s'éloigne alors qu'il était au corps à corps, tant qu'il ne tourne pas le dos ou qu'il n'est pas encerclé, ne peut pas être touché par une AO. Dans ces cas, seul un pouvoir spécial ou un objet spécial peut lui permettre de s'éloigner sans provoquer une AO. Ce pouvoir spécial doit être signalé par le MJ au préalable, sinon il n'est pas opposable aux Pjs.  
Pour toucher, l'attaquant d'opportunité lance son jet de compétence comme s'il s'agissait d'une action offensive normale.
...
Si l'action effectuée avec la 2e main est différente de celle de la 1ere main (cible différente ou arme de nature différente) alors il s'applique un malus supplémentaire de -1D à la 2e main seulement, applicable y compris si le joueur bénéficie d'un effet qui annule le malus d'attaque à deux mains.
Une attaque à deux armes ou avec une double arme est considérée comme étant une seule action d'attaque. Cela a certaines conséquences, par exemple :  
...
Statuts positifs :
_À couvert_ : Le défenseur est derrière un objet solide de sa taille qui le protège. Il devient plus difficile à toucher, avec une difficulté relevée d'un seuil (+5).
_Caché:_ Le défenseur est complètement caché derrière un objet solide de sa taille qui le protège. N'ayant pas effectué d'actions d'attaques ou n'ayant pas bougé le tour précédent, il est tout simplement impossible de l'atteindre à distance.
_Discrétion_ : Le défenseur en mode discrétion ne peut pas être attaqué car il est invisible aux yeux de l'ennemi. Une attaque en mode discrétion ne peut pas être parée ou esquivée, sauf don ou pouvoir particulier, ou réussite à un jet d'intuition. En revanche, cette attaque dévoile la présence du discret.
_En défense_ : Le défenseur en mode défensif gagne +1D à ses éventuelles actions en défense à venir tant qu'il a ce statut.
_Posé_ : Cela signifie que le joueur n'a pas fait d'action de mouvement depuis le tour d'avant. Permet l'utilisation de certains dons.
Statuts négatifs :
_Désorienté_ : Les coups faisant perdre plus de 10 PV d'un coup, ainsi que d'autres actions et objets spéciaux, peuvent désorienter le défenseur. Celui-ci subit un malus de -1D à toutes ses actions jusqu'à la fin de son tour suivant.
_Sonné_ : Les coups faisant perdre plus de 15 PV d'un coup, ainsi que d'autres actions et objets spéciaux, peuvent sonner le défenseur. Celui-ci ne peut plus faire d’action offensive ni utiliser aucun don actif lors de son tour suivant. Il est possible de faire des actions de mouvement et de soutien, ou des actions en défense. Cumulable avec l’état désorienté.
_Déséquilibré_ : Le défenseur a été déséquilibré par un coup dans les membres inférieurs ou par une action spéciale. Pour le déséquilibrer, le coup doit être à au moins 4DD de puissance de base, et le défenseur ajoute +1D à sa res corp, prenant moins de dégâts. Mais il est déséquilibré et ne peut plus faire d'action en défense jusqu'au début de son tour suivant, ou jusqu'à ce qu'il soit touché. Se remettre en position compte pour une action de mouvement. Un défenseur déséquilibré 3 fois perd définitivement -1D de malus à ses actions en défense pour le reste du combat.
_Encerclé / coincé_ : Le défenseur est coincé par des assaillants et/ou d'autres obstacles. Il n'a plus de voie de repli et ne peut plus fuir. Toute action de mouvement engendre une attaque d'opportunité des adversaires. Il peut cependant se ménager une voie de sortie en neutralisant un des adversaires.
_Paralysé_ : Le défenseur a été paralysé par une arme ou un pouvoir particulier, il ne peut tout simplement rien faire jusqu’à la fin de son tour suivant.  
_Empoisonné_ : Le défenseur a été touché par des dégâts empoisonnés. Ceux-ci varient de 1PV par tour à 2D PV par tour selon le poison. Le PJ fait un jet de vigueur opposé au jet de difficulté du poison au début de chaque tour pour savoir s'il continue à subir les effets du poison. La prise d'un antidote (action de soutien) augmente de 10 le jet de vigueur. Le statut poison peut donc être guéri en cours de combat.
_Malade_ : Le défenseur est atteint d'une maladie contractée préalablement au combat. Il subit des malus de la maladie correspondante. Cet état ne peut pas être rétabli en combat.
_Brûlé_ : Le défenseur brûle suite à une attaque brûlante. Il perd 1D PV par tour jusqu'à ce qu'il trouve un moyen de s'éteindre. Cependant il ne peut plus être frappé au corps à corps sans dégâts (1DD), et gagne un bonus de +1DD à ses attaques physiques. 3 tours de suite avec le statut brûlé occasionne des cicatrices et séquelles permanentes.
_Irradié_ : Le défenseur a été irradié. Au bout de 3 tours de combat, il perd 2D PV par tour (2D PV / heure hors combat) et il a un malus de -1D à toutes ses actions. Il faut utiliser un stabilisateur de particules ou une cuve à bacta pour se débarrasser de cet effet, ce qui le rend difficile à soigner en combat.
_Fou_ : Le défenseur est devenu fou, soit parce qu'il a raté son jet de résistance au côté obscur, soit parce qu'un don ou un pouvoir adverse a provoqué cet effet. Il ne contrôle plus ses mouvements, ne se défend plus, et attaque les personnes les plus proches, alliées ou ennemies. Dure 1D tours.
_Agonisant_ : Le défenseur vient de passer en dessous de 0 PV suite à une attaque, il est donc agonisant, c'est à dire qu'il perd 1 PV par tour jusqu'à ce qu'il soit stabilisé, ou soigné, ou jusqu'à ce qu'il meurt. Il peut être stabilisé par un simple jet de médecine à 15, ou l’utilisation d’un medipack quel que soit le jet de médecine. Il acquiert alors le statut Inconscient.
...
Le joueur ne sera donc pas visé, attaqué ou interpellé par les ennemis tant qu'il reste en mode discrétion.
Une action offensive dévoilera sa présence, et il ne pourra alors plus se cacher jusqu'au prochain round.  
...
_Ionique_ : Ignore def des droïdes. Provoque le statut désorienté (jet de chance 7 pour ne pas avoir ce statut). Ce sont des dégâts d'énergie ionique. Les humains y sont insensibles. Ils ont une chance de désactiver les objets électroniques en fonctionnement dans la zone de l'explosion. On peut s'en protéger avec un bouclier d'énergie.
_Plasmique_ : Dégâts énergétiques, produits d'une fusion laser tellement intense qu'ils ignorent la moitié de la résistance corporelle des personnes touchées. Notamment les sabres lasers et les grenades plasmiques. On peut s'en protéger avec un bouclier d'énergie.
_Electrique_ : Ignore def, sauf s'il y a des matériaux isolants spécifiques. On peut s'en protéger avec un bouclier d'énergie.
_Brûlant_ : Ignore 1D res corp, sauf matériaux isolants spécifiques. Provoque le statut « brûlé » (jet de chance 7 pour ne pas avoir ce statut). On peut s'en protéger avec un bouclier d'énergie.
_Impact_ : Ignore def. C'est l'effet de blast d'une puissante arme. Provoque le statut déséquilibré (jet de chance 7 pour ne pas avoir ce statut). On peut s'en protéger avec un bouclier échani.
...
Mais le MJ peut également être sympa et inventer une raison fallacieuse de dernière minute qui expliquerait pourquoi en fait, il n’est pas vraiment mort. L'intervention inopinée d'un PNJ peut par exemple venir sauver le PJ des griffes de la mort, soit en le protégeant d'une partie des dégâts, soit en le soignant avec un médipack en scénarium.  
Cependant, si le MJ a décidé de suivre les règles (pour une fois !) et que le personnage meurt effectivement, le MJ peut choisir d’autoriser la règle du « **baroud d’honneur** » : en cas de mort de personnage, celui-ci pourra, tel Boromir dans le Seigneur des anneaux, réaliser une dernière action d’éclat avant de succomber à ses blessures, poussé par l’énergie du désespoir. Et puis parce que Star Wars est avant tout un film, et qu’un dernier baroud d’honneur d’un personnage stylé, c’est quand même très filmique. Qui n’aurait pas aimé voir Luke Skywalker mourir ainsi dans l’épisode 8 ? Couvert de blessures, l’air déterminé, sur une musique épique, lançant un dernier assaut le sabre laser au poing, permettant ainsi de sauver son apprentie des griffes d’un terrible seigneur Sith ? Bon, finalement le choix du réalisateur aura été de le laisser mourir seul sur un rocher après avoir passé un coup de téléphone à travers la Force… Mais quel MJ injuste et cruel, que celui qui ne permet pas un dernier baroud d’honneur à son joueur !
Le baroud d’honneur, techniquement parlant, permet de réussir n’importe quelle action que le personnage peut habituellement faire sur sa fiche de perso. La réussite de l’action est automatique. Ses conséquences concrètes, elles, sont évidemment décidées par un jet ou par le MJ.
Par exemple, si un Jedi consulaire qui possède le pouvoir de télékinésie meurt dans une grotte, s’il dit « En mourant, j’utilise mon pouvoir de télékinésie pour faire s’écrouler la grotte sur l’ennemi », alors oui la télékinésie sera réussie, par contre quand à savoir dans quelle mesure la grotte s’effondre, et comment l’ennemi se fait écraser en dessous, cela relève de la décision du MJ…
Ou encore, si le baroud d’honneur consiste simplement en « en mourant, je porte une dernière attaque à l’ennemi pour le tuer », l’attaque réussit automatiquement (l’ennemi est touché), mais par contre il faudra lancer le jet de dégâts…
Le baroud d’honneur ne prend pas en compte l’épuisement des dons ou des pouvoirs, le personnage peut vraiment effectuer n’importe quelle action comme s’il était en pleine forme, à la différence qu’à la fin de celle-ci, il s’écroule et meurt, dans une scène filmique d'une vibrante émotion.
Le cas particulier du **wipe** : L'équipe entière a été très imprudente, ou le MJ a très mal dosé la difficulté de son scénario. Et là, c'est le drame, l'équipe entière meurt, c'est ce qu'on appelle un wipe en langage vidéoludique. A moins que le MJ soit particulièrement sévère, voire même sadique, on peut difficilement imaginer la situation où tous les joueurs sortent une fiche de perso neuve pour continuer le scénario avec toute une équipe de nouveaux personnages.  
Cette situation peut se résoudre de deux façons :  
Encore une fois, il peut choisir de sauver les meubles grâce à un improbable retournement de scénario qui expliquerait qu'en fait, les PJ ne sont pas vraiment morts. Il sera cependant nécessaire de punir leur imprudence en leur infligeant de sérieuses séquelles ou en produisant des conséquences négatives sur leur quête.  
Mais le MJ peut aussi choisir de faire simplement recommencer le groupe en l'état où il était avant le combat ou la situation ayant mené au wipe, telle une sauvegarde de jeu vidéo, afin que les joueurs fassent de meilleurs choix. Pour compenser l'imprudence, ils perdent tous 1 PV max.

## Chapitre 4 – Les règles en combat spatial
...
Poursuivi par l'ennemi, poursuivant l'ennemi, Face à face, vol parallèle ou hors de portée.  
Quand il poursuit un ennemi, le pilote a un bonus de +1D pour toucher et +1 au jet de chance pour le coup décisif.  
Quand il est poursuivi par l'ennemi, le pilote ne peut pas le toucher avec les canons du vaisseau ni avec les missiles. Les tourelles et les torpilles fonctionnent. Et le vaisseau ennemi bénéficie de tous les bonus expliqués au point précédent.  
Quand il est face à face à l'ennemi, les vaisseaux se croisent en tirant, il y a alors un jet de pilotage opposé pour savoir qui tirera en premier avec les canons de vaisseaux. Peu importe que cela ne soit pas le tour d'action de l'un ou de l'autre.  
Quand il est en vol parallèle, le pilote ne peut ni tirer avec les canons ni avec les missiles sur le vaisseau ennemi. Seules les tourelles et les torpilles fonctionnent.  
Quand il est hors de portée, le vaisseau ne peut pas tirer sur le vaisseau ennemi avec ses canons principaux, et inversement. Il faut que l'un ou l'autre se rapproche. Le mode hors de portée permet toutefois d’utiliser les missiles si le vaisseau est en ligne de mire.  
Pour passer d'un positionnement à un autre il faut réussir un jet de pilotage opposé pendant une action de mouvement. S'il y a plusieurs vaisseaux ennemis, c'est plus compliqué car le changement de positionnement ne se fait que par rapport à un seul des vaisseaux ennemis.
Pour le changement de positionnement de vaisseau poursuivi à hors de portée, le pilote peut aussi tenter d’activer ses propulseurs au maximum pour se mettre hors de portée de canon, il faut alors réussir un simple jet opposé de vitesse du vaisseau avec les vaisseaux poursuivants. Un vaisseau très rapide peut donc sortir ses occupants de nombreuses situations délicates. Cependant, le vaisseau restera toujours à portée des missiles ennemis tant qu’il n’aura pas fui pour de bon le combat avec un saut en hyperespace.  

**4 – Réparation du vaisseau**  
Le vaisseau peut être réparé en cours de combat par les membres d'équipage. Le réparateur utilise un kit de réparation et lance son jet de réparation. Il le divise par 2 pour savoir combien il rend de point de blindage au vaisseau. Si le réparateur ne dispose pas d'un kit de réparation, il peut cependant utiliser des composants : 1 compo par point de blindage rendu.
Il ne peut y avoir qu'une seule action de réparation pour chaque tour du pilote du vaisseau.  
La réparation produit ses effets seulement au début du tour suivant du pilote.  
La réparation, contrairement à l'utilisation d'un medipack en combat au sol, ne peut pas être interrompue par une attaque ennemie.  
Les statuts de dommage particulier au vaisseau demandent des réparations particulières, voir le point sur les statuts.

**5 – Mode furtif**  
Il est possible que le vaisseau soit équipé d'un appareillage pour le rendre furtif.
Dans ce cas, comme dans le cas d'une embuscade au sol, l'engagement des ennemis se fera avec un tour d'avantage pour les Pjs avant de lancer le jet de pilotage d'initiative qui définira l'ordre des tours d'action.
Il est possible de détecter un vaisseau furtif de la même manière que pour les combats au sol avec le jet d'intuition ou un don ou pouvoir approprié, mais aussi et surtout avec des senseurs particuliers sur le vaisseau permettant de détecter.

**6 – Les coups décisifs**  
Lorsque le vaisseau est touché après que le pilote a perdu à un face à face, ou lorsqu'il est touché par une attaque puissante lui faisant perdre plus du tiers de ses PB d'un coup, ou en cas de don spécifique de l'adversaire, il y a coup décisif. Le pilote du vaisseau touché par un coup décisif doit alors tirer un jet de chance.
Jet de chance 11-12 : Aucune conséquence supplémentaire sur le vaisseau.  
Jet de chance 9-10 : Le vaisseau a ses écrans désactivés.
Jet de chance 7-8 : Le vaisseau a un canon touché.
Jet de chance 5-6 : Le vaisseau a un propulseur touché.
Jet de chance 4 : La soute est touchée et les joueurs perdent 5 objets différents au hasard  
Jet de chance 3 : L'hyperdrive est touché.
Jet de chance 2 : Le vaisseau est dépressurisé.
...
_Hyperdrive touché_ : Le vaisseau perd son hyperdrive et donc sa capacité à passer en hyperespace tant qu'il n'est pas réparé. L'hyperdrive est la pièce la plus chère du vaisseau. Mais il n'est pas perdu tout de suite pour autant, il est possible de le réparer avec un jet de réparation à 20 + kit de réparation + injecteur de photon. Cependant, si la réparation échoue, le réparateur lance un jet de chance : Faire entre 1 et 3 signifie perdre définitivement l'hyperdrive.  
...
En outre, chaque personnel est à un poste où son succès sera déterminé à la fois par ses propres compétences, et par la compétence en commandement du capitaine du vaisseau.
Les différents postes :
\- L’ingénieur radar : il s’occupe des senseurs. Il utilise son jet de. Il permet de détecter les ennemis, déjouer les attaques surprises, détecter les attaques spéciales (torpilles, missiles…)
\- Le gabier : Il gère les boucliers et peut réorienter leur énergie vers la protection de telle ou telle partie du vaisseau à chaque tour, avec son jet d’ingénierie. Un bon gabier peut parfois réactiver des boucliers endommagés en cas d’urgence, au moins le temps de s’enfuir.
\- L’ingénieur radio : Il gère les communications du vaisseau avec l’extérieur, sous toutes ses formes.
\- Le maître machine : il gère les dommages infligés au vaisseau, en rendant compte au capitaine de l’ampleur des dommages, et en gérant l’équipe de réparation. Son jet de réparation lui permet de réparer un certain nombre de points de blindage par tour.
\- Le lieutenant de navigation : Il gère toutes les manœuvres du vaisseau, destinés à s’éloigner ou se rapprocher d’une cible, se mettre hors de portée, s’enfuir, ou partir en hyperespace. Il se sert de son jet de pilotage.
\- Les canonniers : Ils gèrent chacun un armement du vaisseau, avec un jet de tourelle. Les gros vaisseaux peuvent avoir des canons conventionnels, des canons à ions, des torpilles ou des missiles. Les torpilles et les missiles doivent être utilisés avec parcimonie, car ce sont des munitions limitées et très chères. Chaque canonnier peut attaquer à chaque tour.
\- Le maître d’équipage : Il gère les équipages, leur rotation, leurs repos, leurs affectations ; il déclenche également les équipes de chasseurs dans les hangars, à son initiative ou sur ordre du capitaine.
\- Le capitaine : Il fait un jet de commandement donc chaque seuil amène un bonus de +1 à tous les postes (s’il fait 20, cela fait 4 seuils, donc un bonus de +4 aux jets de tout son personnel). Il peut aussi se concentrer sur un poste en particulier pour apporter des ordres ou un bonus supplémentaire (le double du bonus initial, tant que l’attention est concentrée sur ce poste)
\- Le second du capitaine : Il remplace le rôle du capitaine lorsque celui ci est occupé ou empêché.
Attaque :
Pour attaquer, il faut déjà se mettre à portée de la cible. C’est l’ingénieur radar qui permettra de localiser la cible avec précision, puis le lieutenant de navigation qui gère la manœuvre, dont la difficulté dépend de la vitesse et de la maniabilité du vaisseau ennemi, et ses éventuels dispositifs de furtivité.
Ensuite, les canonniers peuvent chacun déclencher leurs armes avec un jet de tourelle, opposé au jet d’esquive spatiale ennemie.
Angle mort : Les petits vaisseaux peuvent se défendre des attaques de gros vaisseaux en se mettant dans un angle mort de leurs armements. Pour cela, il faut qu’ils aient été attaqués au moins une fois auparavant, puis qu’ils réussissent un jet de pilotage opposé au jet de pilotage du lieutenant de navigation du gros vaisseau. Le lieutenant de navigation est souvent désavantagé, car les pilotes de petits vaisseaux ont souvent un bonus de maniabilité grâce à leur vaisseau. Dans un angle mort, un petit vaisseau ne peut plus être touché par les armements conventionnels, mais seulement par les torpilles et les missiles.
Défense :
Les gros vaisseaux ne peuvent pas effectuer de manœuvres d’évitement. En revanche, ils sont bardés de tourelles automatiques qui tirent sur les petits vaisseaux qui s’approchent trop pour l’attaquer.
Ainsi, un petit vaisseau qui veut attaquer un gros vaisseau devra à la fois obtenir au moins 10 à son jet de pilotage pour toucher, et au moins 15 dans le même jet pour ne pas être touché en attaquant.
Les tourelles automatiques engendrent des dommages de 4DD par défaut, mais peuvent être plus puissantes.
Les torpilles et missiles ne peuvent pas rater un gros vaisseau, cependant là encore, des dispositifs d’interception automatiques peuvent faire échouer ce type d’attaque, il faudra à chaque attaque lancer un jet de chance pour toucher, dont la difficulté augmente en fonction de la qualité du dispositif d’interception ennemi.
Et lorsqu’un gros vaisseau attaque un gros vaisseau, il n’a pas besoin de se rapprocher autant, donc ce ne sont pas les tourelles automatiques qui s’activent, mais tout simplement les armements principaux de l’un contre l’autre.
Points vitaux : Les points vitaux des gros vaisseaux sont le générateur de bouclier (sur le dessus), le moteur hyperdrive (à l’arrière), Les hangars (sur les côtés), les senseurs (à l’avant), et le pont.
Chaque point vital comporte un certain nombre de points de blindage, et une fois qu’ils sont tous détruits, le gros vaisseau est détruit et part à la dérive.
